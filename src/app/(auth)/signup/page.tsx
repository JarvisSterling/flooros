  ...
  if (success) {
    return (
      <div className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-xl p-8 shadow-2xl text-center">
        ...
        <Link href="/login" className="mt-6 inline-block text-sm text-blue-400 hover:text-blue-300 transition">
          Back to login
        </Link>
      </div>
    );
  ...
  return (
    <div className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-xl p-8 shadow-2xl">
      ...
      <form onSubmit={handleSignup} className="space-y-4">
        ...
        <div>
          <label htmlFor="confirmPassword" className="block text-sm font-medium text-white/70 mb-1">Confirm password</label>
      ...
      <button onClick={handleGoogle}
        className="w-full rounded-lg border border-white/10 bg-white/5 py-2.5 text-sm font-medium text-white transition hover:bg-white/10 flex items-center justify-center gap-2">
      ...
      <p className="mt-6 text-center text-sm text-white/50">
        ...
        <Link href="/login" className="text-blue-400 hover:text-blue-300 transition font-medium">Sign in</Link>
      </p>
    </div>
  );
}
